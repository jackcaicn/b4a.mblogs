...
public class httputilsservice extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "b4a.mblogs", "b4a.mblogs.httputilsservice");
            try {
        ...
        anywheresoftware.b4a.keywords.Common.Log("** Service (httputilsservice) Create **");
    ...
    private void handleStart(android.content.Intent intent) {
    	anywheresoftware.b4a.keywords.Common.Log("** Service (httputilsservice) Start **");
	...
	public void onDestroy() {
        anywheresoftware.b4a.keywords.Common.Log("** Service (httputilsservice) Destroy **");
...
String _link = "";
 //BA.debugLineNum = 107;BA.debugLine="Sub HandleError(TaskId As Int, Reason As String)";
 //BA.debugLineNum = 108;BA.debugLine="Dim link As String";
_link = "";
 //BA.debugLineNum = 109;BA.debugLine="link = taskToRequest.Get(TaskId)";
_link = String.valueOf(_tasktorequest.Get((Object)(_taskid)));
 //BA.debugLineNum = 110;BA.debugLine="Log(\"Error. Url=\" & link & \" Message=\" & Reason)";
...
public static String  _hc_responseerror(anywheresoftware.b4a.http.HttpClientWrapper.HttpResponeWrapper _response,String _reason,int _statuscode,int _taskid) throws Exception{
 //BA.debugLineNum = 96;BA.debugLine="Sub hc_ResponseError (Response As HttpResponse, Reason As String, StatusCode As Int, TaskId As Int)";
 //BA.debugLineNum = 97;BA.debugLine="countWorking = countWorking - 1";
_countworking = (int)(_countworking-1);
 //BA.debugLineNum = 98;BA.debugLine="finishTasks = finishTasks + 1";
_finishtasks = (int)(_finishtasks+1);
 //BA.debugLineNum = 99;BA.debugLine="HandleError(TaskId, Reason)";
_handleerror(_taskid,_reason);
 //BA.debugLineNum = 100;BA.debugLine="If Response <> Null Then";
if (_response!= null) { 
 //BA.debugLineNum = 101;BA.debugLine="Log(Response.GetString(\"UTF8\"))";
anywheresoftware.b4a.keywords.Common.Log(_response.GetString("UTF8"));
 //BA.debugLineNum = 102;BA.debugLine="Response.Release";
_response.Release();
 };
 //BA.debugLineNum = 104;BA.debugLine="ProcessNextTask";
_processnexttask();
...
public static String  _hc_responsesuccess(anywheresoftware.b4a.http.HttpClientWrapper.HttpResponeWrapper _response,int _taskid) throws Exception{
 //BA.debugLineNum = 76;BA.debugLine="Sub hc_ResponseSuccess (Response As HttpResponse, TaskId As Int)";
 //BA.debugLineNum = 77;BA.debugLine="Response.GetAsynchronously(\"response\", File.OpenOutput(TempFolder, TaskId, False), _ 		True, TaskId)";
...
anywheresoftware.b4a.http.HttpClientWrapper.HttpUriRequestWrapper _req = null;
 //BA.debugLineNum = 42;BA.debugLine="Sub ProcessNextTask";
 //BA.debugLineNum = 43;BA.debugLine="If finishTasks >= HttpUtils.Tasks.Size Then";
if (_finishtasks>=mostCurrent._httputils._tasks.getSize()) { 
 //BA.debugLineNum = 44;BA.debugLine="HttpUtils.Working = False";
mostCurrent._httputils._working = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 45;BA.debugLine="HttpUtils.Complete = True";
mostCurrent._httputils._complete = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 47;BA.debugLine="If HttpUtils.CallbackJobDoneSub <> \"\" Then";
if ((mostCurrent._httputils._callbackjobdonesub).equals("") == false) { 
 //BA.debugLineNum = 48;BA.debugLine="CallSub2(HttpUtils.CallbackActivity, HttpUtils.CallbackJobDoneSub, HttpUtils.Job)";
anywheresoftware.b4a.keywords.Common.CallSub2(processBA,(Object)(mostCurrent._httputils._callbackactivity),mostCurrent._httputils._callbackjobdonesub,(Object)(mostCurrent._httputils._job));
 };
 //BA.debugLineNum = 51;BA.debugLine="If HttpUtils.Working = False Then";
if (mostCurrent._httputils._working==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 52;BA.debugLine="StopService(\"\")";
anywheresoftware.b4a.keywords.Common.StopService(processBA,(Object)(""));
 };
 //BA.debugLineNum = 54;BA.debugLine="Return";
if (true) return "";
 };
 //BA.debugLineNum = 56;BA.debugLine="If task >= HttpUtils.Tasks.Size Then Return";
if (_task>=mostCurrent._httputils._tasks.getSize()) { 
if (true) return "";};
 //BA.debugLineNum = 57;BA.debugLine="Dim link As String";
_link = "";
 //BA.debugLineNum = 58;BA.debugLine="link = HttpUtils.Tasks.Get(task)";
...
_req = new anywheresoftware.b4a.http.HttpClientWrapper.HttpUriRequestWrapper();
 //BA.debugLineNum = 60;BA.debugLine="If Post Then";
if (_post) { 
 //BA.debugLineNum = 61;BA.debugLine="If PostInputStream.IsInitialized Then";
if (_postinputstream.IsInitialized()) { 
 //BA.debugLineNum = 62;BA.debugLine="req.InitializePost(link, PostInputStream, PostLength)";
_req.InitializePost(_link,(java.io.InputStream)(_postinputstream.getObject()),_postlength);
 }else {
 //BA.debugLineNum = 64;BA.debugLine="req.InitializePost2(link, PostBytes)";
_req.InitializePost2(_link,_postbytes);
 };
 }else {
 //BA.debugLineNum = 67;BA.debugLine="req.InitializeGet(link)";
_req.InitializeGet(_link);
 };
 //BA.debugLineNum = 70;BA.debugLine="countWorking = countWorking + 1";
_countworking = (int)(_countworking+1);
 //BA.debugLineNum = 71;BA.debugLine="taskToRequest.Put(task, link)";
_tasktorequest.Put((Object)(_task),(Object)(_link));
 //BA.debugLineNum = 72;BA.debugLine="hc.Execute(req, task)";
_hc.Execute(processBA,_req,_task);
 //BA.debugLineNum = 73;BA.debugLine="task = task + 1";
_task = (int)(_task+1);
 //BA.debugLineNum = 74;BA.debugLine="End Sub";
return "";
}
public static String  _response_streamfinish(boolean _success,int _taskid) throws Exception{
 //BA.debugLineNum = 81;BA.debugLine="Sub Response_StreamFinish (Success As Boolean, TaskId As Int)";
 //BA.debugLineNum = 82;BA.debugLine="finishTasks = finishTasks + 1";
_finishtasks = (int)(_finishtasks+1);
 //BA.debugLineNum = 83;BA.debugLine="countWorking = countWorking - 1";
_countworking = (int)(_countworking-1);
 //BA.debugLineNum = 84;BA.debugLine="If Success = False Then";
if (_success==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 85;BA.debugLine="HandleError(TaskId, LastException.Message)";
_handleerror(_taskid,anywheresoftware.b4a.keywords.Common.LastException(processBA).getMessage());
 }else {
 //BA.debugLineNum = 87;BA.debugLine="HttpUtils.SuccessfulUrls.Put(taskToRequest.Get(TaskId), TaskId)";
mostCurrent._httputils._successfulurls.Put(_tasktorequest.Get((Object)(_taskid)),(Object)(_taskid));
 //BA.debugLineNum = 89;BA.debugLine="If HttpUtils.CallbackUrlDoneSub <> \"\" Then";
if ((mostCurrent._httputils._callbackurldonesub).equals("") == false) { 
 //BA.debugLineNum = 90;BA.debugLine="CallSub2(HttpUtils.CallbackActivity, HttpUtils.CallbackUrlDoneSub, taskToRequest.Get(TaskId))";
anywheresoftware.b4a.keywords.Common.CallSub2(processBA,(Object)(mostCurrent._httputils._callbackactivity),mostCurrent._httputils._callbackurldonesub,_tasktorequest.Get((Object)(_taskid)));
 };
 };
 //BA.debugLineNum = 93;BA.debugLine="ProcessNextTask";
_processnexttask();
...
public static String  _service_create() throws Exception{
 ...
 //BA.debugLineNum = 23;BA.debugLine="If TempFolder = \"\" Then TempFolder = File.DirInternalCache";
if ((_tempfolder).equals("")) { 
_tempfolder = anywheresoftware.b4a.keywords.Common.File.getDirInternalCache();};
 //BA.debugLineNum = 24;BA.debugLine="If hcIsInitialized = False Then";
if (_hcisinitialized==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 25;BA.debugLine="hc.Initialize(\"hc\")";
_hc.Initialize("hc");
 //BA.debugLineNum = 26;BA.debugLine="hcIsInitialized = True";
...
public static String  _service_destroy() throws Exception{
 //BA.debugLineNum = 113;BA.debugLine="Sub Service_Destroy";
 //BA.debugLineNum = 114;BA.debugLine="HttpUtils.Working = False";
mostCurrent._httputils._working = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 115;BA.debugLine="End Sub";
return "";
}
public static String  _service_start() throws Exception{
 //BA.debugLineNum = 30;BA.debugLine="Sub Service_Start";
 //BA.debugLineNum = 31;BA.debugLine="If HttpUtils.Tasks.IsInitialized = False Then Return";
if (mostCurrent._httputils._tasks.IsInitialized()==anywheresoftware.b4a.keywords.Common.False) { 
if (true) return "";};
 //BA.debugLineNum = 32;BA.debugLine="taskToRequest.Initialize";
_tasktorequest.Initialize();
 //BA.debugLineNum = 33;BA.debugLine="finishTasks = 0";
_finishtasks = (int)(0);
 //BA.debugLineNum = 34;BA.debugLine="task = 0";
_task = (int)(0);
 //BA.debugLineNum = 35;BA.debugLine="countWorking = 0";
_countworking = (int)(0);
 //BA.debugLineNum = 36;BA.debugLine="Do While task < HttpUtils.Tasks.Size";
while (_task<mostCurrent._httputils._tasks.getSize()) {
 //BA.debugLineNum = 37;BA.debugLine="ProcessNextTask";
_processnexttask();
 //BA.debugLineNum = 38;BA.debugLine="If countWorking >= maxTasks Then Exit";

...
anywheresoftware.b4a.objects.drawable.ColorDrawable _col = null;
 ...
 //BA.debugLineNum = 38;BA.debugLine="container.Initialize";
mostCurrent._container.Initialize(mostCurrent.activityBA);
 //BA.debugLineNum = 39;BA.debugLine="For i = 0 To 5";
{
final double step10 = 1;
final double limit10 = (int)(5);
for (_i = (int)(0); (step10 > 0 && _i <= limit10) || (step10 < 0 && _i >= limit10); _i += step10) {
 //BA.debugLineNum = 40;BA.debugLine="Dim pan As Panel";
_pan = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 42;BA.debugLine="pan = CreatePanel(\"ListView \" & (i - 1))";
_pan = _createpanel("ListView "+BA.NumberToString((_i-1)));
 //BA.debugLineNum = 43;BA.debugLine="container.AddPage(pan,\"ListView \" & i)";
mostCurrent._container.AddPage((android.view.View)(_pan.getObject()),"ListView "+BA.NumberToString(_i));
 }
};
 //BA.debugLineNum = 48;BA.debugLine="pager.Initialize(container, \"Pager\")";
mostCurrent._pager.Initialize(mostCurrent.activityBA,mostCurrent._container,"Pager");
 //BA.debugLineNum = 51;BA.debugLine="tabs.Initialize(pager)";
mostCurrent._tabs.Initialize(mostCurrent.activityBA,mostCurrent._pager);
 //BA.debugLineNum = 52;BA.debugLine="tabs.LineHeight = 5dip";
mostCurrent._tabs.setLineHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int)(5)));
 //BA.debugLineNum = 53;BA.debugLine="tabs.UpperCaseTitle = True";
mostCurrent._tabs.setUpperCaseTitle(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 54;BA.debugLine="Activity.AddView(tabs, 0, 0, -1, -2)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._tabs.getObject()),(int)(0),(int)(0),(int)(-1),(int)(-2));
 //BA.debugLineNum = 57;BA.debugLine="Dim col As ColorDrawable";
_col = new anywheresoftware.b4a.objects.drawable.ColorDrawable();
 //BA.debugLineNum = 58;BA.debugLine="col.Initialize(tabs.LineColorCenter, 0)";
_col.Initialize(mostCurrent._tabs.getLineColorCenter(),(int)(0));
 //BA.debugLineNum = 59;BA.debugLine="line.Initialize(\"\")";
mostCurrent._line.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 60;BA.debugLine="line.Background=col";
mostCurrent._line.setBackground((android.graphics.drawable.Drawable)(_col.getObject()));
 //BA.debugLineNum = 61;BA.debugLine="Activity.AddView(line, 0, 35dip, Activity.Width, 2dip)";
mostCurrent._activity.AddView((android.view.View)(mostCurrent._line.getObject()),(int)(0),anywheresoftware.b4a.keywords.Common.DipToCurrent((int)(35)),mostCurrent._activity.getWidth(),anywheresoftware.b4a.keywords.Common.DipToCurrent((int)(2)));
 //BA.debugLineNum = 64;BA.debugLine="Activity.AddView(pager, 0, 35dip + 2dip, Activity.Width, Activity.Height-48dip-35dip-2dip)";
...
public static anywheresoftware.b4a.objects.PanelWrapper  _createpanel(String _title) throws Exception{
anywheresoftware.b4a.objects.PanelWrapper _pan = null;
anywheresoftware.b4a.objects.ListViewWrapper _lv = null;
int _i = 0;
 //BA.debugLineNum = 83;BA.debugLine="Sub CreatePanel(Title As String) As Panel";
 //BA.debugLineNum = 84;BA.debugLine="Dim pan As Panel";
_pan = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 86;BA.debugLine="pan.Initialize(\"\")";
_pan.Initialize(mostCurrent.activityBA,"");
 //BA.debugLineNum = 88;BA.debugLine="Dim lv As ListView";
_lv = new anywheresoftware.b4a.objects.ListViewWrapper();
 //BA.debugLineNum = 90;BA.debugLine="lv.Initialize(\"LV\")";
_lv.Initialize(mostCurrent.activityBA,"LV");
 //BA.debugLineNum = 92;BA.debugLine="For i = 0 To 30";
{
final double step36 = 1;
final double limit36 = (int)(30);
for (_i = (int)(0); (step36 > 0 && _i <= limit36) || (step36 < 0 && _i >= limit36); _i += step36) {
 //BA.debugLineNum = 93;BA.debugLine="lv.AddSingleLine(\"List Entry \" & i)";
_lv.AddSingleLine("List Entry "+BA.NumberToString(_i));
 }
};
 //BA.debugLineNum = 96;BA.debugLine="pan.AddView(lv, 0, 0, -1, -1)";
_pan.AddView((android.view.View)(_lv.getObject()),(int)(0),(int)(0),(int)(-1),(int)(-1));
 //BA.debugLineNum = 99;BA.debugLine="pan.Tag = \"\"";
_pan.setTag((Object)(""));
 //BA.debugLineNum = 100;BA.debugLine="Return pan";
if (true) return _pan;
...
public static String  _globals() throws Exception{
 ...
 //BA.debugLineNum = 24;BA.debugLine="Dim container As AHPageContainer";
mostCurrent._container = new de.amberhome.viewpager.AHPageContainer();
 //BA.debugLineNum = 25;BA.debugLine="Dim pager As AHViewPager";
mostCurrent._pager = new de.amberhome.viewpager.AHViewPager();
 //BA.debugLineNum = 27;BA.debugLine="Dim tabs As AHViewPagerTabs";
mostCurrent._tabs = new de.amberhome.viewpager.AHViewPagerTabs();
 //BA.debugLineNum = 30;BA.debugLine="Dim line As Panel";
